...
--Exporting data to a new table to hold result of a query e.g., names of employees retiring based on dates provided
SELECT first_name, last_name
...
-- Employee count by department number. Result from above in ordered according to dept. no
SELECT COUNT(ce.emp_no), de.dept_no
